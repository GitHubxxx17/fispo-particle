...
const Route0 = React3.lazy(() => __vitePreload(() => import("./assets/helloworld-DOFo62z_.js"), true ? [] : void 0));
const routes = [
...
const build = () => {
  const lookup = (reducer) => {
    return reduce(styles$8, (o$$1, style, prefix) => {
  ...
  const hasRegular = "far" in styles$8 || config.autoFetchSvg;
...
function applyShimAndAlias(skipLookups, givenPrefix, canonical) {
  ...
  if (prefix === "far" && !styles$8["far"] && styles$8["fas"] && !config.autoFetchSvg) {
    prefix = "fas";
  }
  return {
    prefix,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      className: classNames(styles$9.nav, {
        ...
        [styles$9["nav-blue"]]: isBlue
      }),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$9["blog-name"], children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: "#", children: title2 }) }),
...
const Post = (props) => {
  console.log(props);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.post, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: props.path, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: props.title }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6["category-and-date"], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$6.category, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { href: `/category/${props.categories}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "folder-open" }),
        props.categories
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$6.date, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "calendar" }),
        props.date
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.description, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { dangerouslySetInnerHTML: { __html: props.info } }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6["post-tags"], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "tags" }),
      props.tags.map((tag, index) => {
        return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: `/tag/${tag}`, style: { color: getRandomColor() }, children: tag }) }, index);
      })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: props.path, className: styles$6["go-post"], children: "阅读全文" })
  ] });
};
function HomeLayout(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.homeLayout, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { src: banner.img, alt: "" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7["home-info"], children: [
        Array.from({ length: 4 }).map((_, i) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.loop }, i);
        }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.info, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: title2 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: banner.subTitle })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7["home-posts-wrap"], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7["home-posts"], children: articlesList.map((article, index) => {
        return /* @__PURE__ */ reactExports.createElement(Post, { ...article, key: index });
      }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7["home-card"], children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7["home-card-inner"], children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.avatar, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { src: avatar2, alt: "avatar" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.name, children: author }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.description, children: description2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7["icon-links"], children: iconList.map((item, index) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7["icon-link"], children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: "", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: item }) }) }, index);
        }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7["friend-links"] })
      ] }) })
    ] })
  ] });
}
...
const Footer = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: styles$5.footer, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5["footer-wrap"], children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Based on the",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: "https://github.com/GitHubxxx17/fispo", children: "Fispo Engine" }),
      "|",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: "https://github.com/GitHubxxx17/fispo", children: "Particle Theme" })
    ] })
  ] }) });
};
const emptyComponents = {};
const MDXContext = React3.createContext(emptyComponents);
function useMDXComponents(components) {
  const contextComponents = React3.useContext(MDXContext);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.articleLayout, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.header, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.info, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { href: `/category/${frontmatter.categories}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "folder-open" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          ...
          frontmatter.tags.map((tag, index) => {
            return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: `/tag/${tag}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: getRandomColor() }, children: tag }) }, index);
          })
        ] })
      ] })
    ] }),
...
const ArticleCard = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.articleCard, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: props.path, className: styles$1.title, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: props.title }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.info, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { href: `/category/${props.categories}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { icon: "folder-open" }),
        props.categories
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
...
const Layout = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$a.layout, children: [
...
async function initPageData(routePath) {
  ...
  const { articlesList, tags: tags2, categories } = await handleRoutes(
    routes,
    siteData.postDir
  );
  ...
  if (isNav) {
    ...
    const title2 = (_b = moduleInfo == null ? void 0 : moduleInfo.frontmatter) == null ? void 0 : _b.title;
    if (title2) {
      bannerTitle = title2;
